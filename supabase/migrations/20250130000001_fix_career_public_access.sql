...
-- Only proceed if career tables exist
DO $$
BEGIN
    -- Check if career_categories table exists
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'career_categories' AND table_schema = 'public') THEN
