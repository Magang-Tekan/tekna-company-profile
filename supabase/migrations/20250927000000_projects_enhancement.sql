-- Migration: Projects Enhancement
-- Description: Additional project fields, functions, and indexes for project detail pages
-- Created: 2025-09-27 (consolidated from multiple migrations)
...
GRANT EXECUTE ON FUNCTION get_project_by_slug(TEXT, TEXT) TO anon;
GRANT EXECUTE ON FUNCTION get_project_by_slug(TEXT, TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION get_project_images(UUID) TO anon;
GRANT EXECUTE ON FUNCTION get_project_images(UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION get_related_projects(UUID, TEXT, INTEGER) TO anon;
GRANT EXECUTE ON FUNCTION get_related_projects(UUID, TEXT, INTEGER) TO authenticated;
...
GRANT EXECUTE ON FUNCTION search_projects(TEXT, TEXT, INTEGER, INTEGER) TO anon;
GRANT EXECUTE ON FUNCTION search_projects(TEXT, TEXT, INTEGER, INTEGER) TO authenticated;
