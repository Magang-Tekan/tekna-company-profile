-- Migration: Content Management System
-- Description: About Us, FAQs, Team Members tables and translations
-- Created: 2025-01-03 (consolidated from multiple migrations)
...
-- About Us: Admins and editors can manage
CREATE POLICY "Admins and editors can manage about us" ON about_us
    FOR ALL USING (get_user_role(auth.uid()) IN ('admin', 'editor'));

-- FAQs: Admins and editors can manage
CREATE POLICY "Admins and editors can manage FAQs" ON faqs
    FOR ALL USING (get_user_role(auth.uid()) IN ('admin', 'editor'));

-- Team members: Admins and editors can manage
CREATE POLICY "Admins and editors can manage team members" ON team_members
    FOR ALL USING (get_user_role(auth.uid()) IN ('admin', 'editor'));

-- About Us translations: Admins and editors can manage
CREATE POLICY "Admins and editors can manage about us translations" ON about_us_translations
    FOR ALL USING (get_user_role(auth.uid()) IN ('admin', 'editor'));

-- FAQ translations: Admins and editors can manage
CREATE POLICY "Admins and editors can manage FAQ translations" ON faq_translations
    FOR ALL USING (get_user_role(auth.uid()) IN ('admin', 'editor'));

-- Team member translations: Admins and editors can manage
CREATE POLICY "Admins and editors can manage team member translations" ON team_member_translations
    FOR ALL USING (get_user_role(auth.uid()) IN ('admin', 'editor'));
