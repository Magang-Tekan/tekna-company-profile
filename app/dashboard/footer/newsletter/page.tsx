...
export default function NewsletterPage() {
  ...
  const [editingNewsletter, setEditingNewsletter] = useState<NewsletterSettings | null>(null)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingNewsletter) {
        await footerService.updateNewsletterSettings(editingNewsletter.id, formData)
  ...
  const handleDelete = async (id: string) => {
    if (!confirm('Are you sure you want to delete this newsletter setting?')) return
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>
                {editingNewsletter ? 'Edit Newsletter Settings' : 'Create Newsletter Settings'}
              </DialogTitle>
              <DialogDescription>
                {editingNewsletter 
        ...
        {newsletterSettings.length === 0 && (
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">No newsletter settings found</h3>
              ...
              .map((newsletter) => (
                <div key={newsletter.id} className="p-4 bg-muted rounded-lg">
                  ...
                  <div className="flex gap-2">
                    <Input 
                      placeholder={newsletter.placeholder_text || 'Enter your email'} 
                      className="flex-1"
                      disabled
                    />
                    <Button disabled>
