...
export default function LocationsPage() {
  ...
  const handleDelete = async (id: string) => {
    ...
    if (location.positions_count && location.positions_count > 0) {
      toast.error(`Cannot delete location. It has ${location.positions_count} positions.`)
      return
    }
      ...
      {showAddForm && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Create a new job position location</CardDescription>
          </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center space-x-2 pt-8">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => setFormData({ ...formData, is_remote: checked === true })}
                />
            ...
            <CardHeader>
              <div className="flex items-start justify-between">
                  ...
                  {editingId === location.id ? (
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => setFormData({ ...formData, is_remote: checked === true })}
                        />
                        <Label htmlFor={`edit-remote-${location.id}`} className="flex items-center gap-2">
                    ...
                    <>
                      ...
                      <CardDescription>
                        ...
                        {`, ${location.country}`}
                        {location.timezone && (
                          <div className="text-xs mt-1">Timezone: {location.timezone}</div>
                        )}
                      </CardDescription>
                    </>
                  )}
                ...
                <div className="flex gap-1 ml-2">
                  {editingId === location.id ? (
                    <>
                      <Button size="sm" variant="outline" onClick={() => handleEdit(location.id)}>
                    ...
                    <>
                      ...
                      <Button 
                        ...
                        disabled={Boolean(location.positions_count && location.positions_count > 0)}
                      >
