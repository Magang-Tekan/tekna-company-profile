...
export default function TypesPage() {
  ...
  const handleDelete = async (id: string) => {
    ...
    if (type.positions_count && type.positions_count > 0) {
      toast.error(`Cannot delete type. It has ${type.positions_count} positions.`)
      return
    }
            ...
            <CardHeader>
              <div className="flex items-start justify-between">
                ...
                <div className="flex gap-1 ml-2">
                  {editingId === type.id ? (
                    <>
                      <Button size="sm" variant="outline" onClick={() => handleEdit(type.id)}>
                    ...
                    <>
                      ...
                      <Button 
                        ...
                        disabled={Boolean(type.positions_count && type.positions_count > 0)}
                      >
