...
export default function CategoriesPage() {
  ...
  const handleDelete = async (id: string) => {
    ...
    if (category.positions_count && category.positions_count > 0) {
      toast.error(`Cannot delete category. It has ${category.positions_count} positions.`)
      return
    }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Career Categories</h1>
          <p className="text-muted-foreground">Manage job position categories</p>
        </div>
      ...
      {showAddForm && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Create a new job position category</CardDescription>
          </CardHeader>
                  ...
                  {editingId === category.id ? (
                    ...
                    <>
                      ...
                      <Button 
                        ...
                        disabled={Boolean(category.positions_count && category.positions_count > 0)}
                      >
