...
export default function ProfileSettingsForm({ className }: React.ComponentPropsWithoutRef<"div">) {
  ...
  return (
    ...
    <CardDescription>Perbarui nama tampilan dan detail profil Anda. Email tidak dapat diubah di sini.</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">Email tidak dapat diubah di halaman profil. Untuk mengubah alamat email, gunakan pengaturan akun atau hubungi administrator.</p>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                    <Label>Status</Label>
                    <Badge variant={currentUser.is_active ? "default" : "secondary"}>{currentUser.is_active ? 'Active' : 'Inactive'}</Badge>
                </div>
            </div>
