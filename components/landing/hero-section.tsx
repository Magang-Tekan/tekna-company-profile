...
export function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-screen bg-gradient-to-b from-background via-background/50 to-background">
      {/* Globe Background - Full Sphere Visible */}
      ...
      {/* Text Overlay - Clean without Background */}
